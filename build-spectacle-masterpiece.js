...
const collectionsData = fs.readFileSync('collections-b64-data.json', 'utf8').trim();
...
<head>
  ...
  <title>Greek Colors Colors — Spectacle-Driven Luxury Experience</title>
  <meta name="description" content="Some colors are worn. Others are carried. Wear Your Colors. Greek Colors Colors presents an award-level digital spectacle celebrating Sigma Gamma Rho Sorority, Inc. fine jewelry & custom design by Master Jeweler Roslyn Kiser Miller.">
  ...
  <style>
    ...
    * {
    ...
    @keyframes threadGlint {
      0% { stroke-dashoffset: 1000; }
      100% { stroke-dashoffset: 0; }
    }
    .gold-thread {
      stroke-dasharray: 1000;
      animation: threadGlint 6s ease-in-out infinite alternate;
    }
...
<body class="min-h-screen flex flex-col selection:bg-[#CCA147] selection:text-[#001B55]">
  ...
  <!-- CANVAS PARTICLES & ATMOSPHERE SHADER -->
  ...
  <header id="main-header" class="sticky top-0 z-40 glass-nav px-6 lg:px-16 py-4 transition-opacity duration-1000">
    <div class="max-w-7xl mx-auto flex items-center justify-between">
      ...
      <nav class="hidden md:flex items-center space-x-8 text-xs font-serif uppercase tracking-[0.2em] text-[#FCFFFE]/90">
        <a href="#scene-01" onclick="switchTab('storefront')" class="interactive-el hover:text-[#CCA147] transition">I. Hero</a>
        <a href="#scene-02" onclick="switchTab('storefront')" class="interactive-el hover:text-[#CCA147] transition">II. Meaning</a>
        <a href="#scene-03" onclick="switchTab('storefront')" class="interactive-el hover:text-[#CCA147] transition">III. Masterpiece</a>
        <a href="#scene-04" onclick="switchTab('storefront')" class="interactive-el hover:text-[#CCA147] transition">IV. Carousels (120 Pieces)</a>
        <a href="#scene-05" onclick="switchTab('storefront')" class="interactive-el hover:text-[#CCA147] transition">V. Sisterhood</a>
        <a href="#scene-06" onclick="switchTab('storefront')" class="interactive-el hover:text-[#CCA147] transition">VI. Customization</a>
        <a href="#scene-07" onclick="switchTab('storefront')" class="interactive-el hover:text-[#CCA147] transition">VII. Legacy</a>
      </nav>
  ...
  <!-- STOREFRONT CONTENT (8 CINEMATIC SCENES) -->
  <div id="view-storefront" class="tab-content relative z-10">

    <!-- ==========================================
         SCENE 01 — HERO (FIRST 5 SECONDS CINEMATIC REVEAL)
         ========================================== -->
    <section id="scene-01" class="act-scene min-h-[92vh] flex items-center justify-center relative py-28 px-6 lg:px-16 overflow-hidden bg-gradient-to-b from-[#00123A] via-[#001B55] to-[#003399]/30">
      
      <div class="absolute top-1/3 left-1/2 -translate-x-1/2 w-[750px] h-[750px] bg-[#003399]/35 rounded-full blur-[160px] pointer-events-none"></div>
      <div class="absolute top-1/4 right-10 w-[500px] h-[500px] bg-[#CCA147]/20 rounded-full blur-[140px] pointer-events-none"></div>
      ...
      <div class="max-w-5xl mx-auto text-center relative z-10">
        ...
        <div class="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-[#001B55] border border-[#CCA147] text-[#E7CA83] text-xs font-serif uppercase tracking-[0.35em] mb-8 shadow-[0_0_35px_rgba(204,161,71,0.35)]">
          <span>✨</span> Scene 01 • The First 5 Seconds
        </div>

        <!-- Sequential Cinematic Title Sequence -->
        ...
        <p class="max-w-2xl mx-auto text-base sm:text-lg text-[#FCFFFE]/90 font-sans leading-relaxed mb-12 font-light">
          Greek Colors Colors creates luxury fine jewelry & bespoke custom design inspired by identity, sisterhood, and the colors that connect generations.
        </p>

        <div class="flex flex-col sm:flex-row items-center justify-center gap-5">
          <a href="#scene-04" class="interactive-el btn-gold px-10 py-5 rounded-sm font-serif text-xs uppercase tracking-[0.25em] w-full sm:w-auto">
            Explore 120 Real Jewelry Pieces →
          </a>
    ...
    <!-- ==========================================
         SCENE 02 — COLOR HAS MEANING (SILK & GOLD THREAD)
         ========================================== -->
    <section id="scene-02" class="act-scene py-28 px-6 lg:px-16 max-w-7xl mx-auto border-b border-[#CCA147]/25 text-center">
      <span class="text-xs font-serif uppercase tracking-[0.35em] text-[#CCA147] block mb-3">Scene 02 • Color Has Meaning</span>
      <h2 class="text-3xl sm:text-6xl font-serif font-bold text-[#FCFFFE] tracking-wide uppercase mb-6">
        A THREAD OF PURE GOLD
      </h2>
      <p class="max-w-xl mx-auto text-sm text-[#FCFFFE]/85 mb-10 font-editorial italic text-lg">
        &ldquo;Connecting Sisterhood, Identity, and Legacy across generations.&rdquo;
      </p>

      <!-- Interactive Gold Thread Canvas SVG -->
      <div class="relative w-full max-w-3xl mx-auto h-48 glass-liquid rounded-2xl p-6 flex items-center justify-center border border-[#CCA147]/40 shadow-2xl mb-10">
        <svg class="w-full h-full" viewBox="0 0 600 100">
          <path class="gold-thread" d="M 10 50 Q 150 10 300 50 T 590 50" fill="none" stroke="#CCA147" stroke-width="3" stroke-linecap="round"/>
        </svg>
        <div class="absolute inset-0 flex items-center justify-around text-xs font-serif uppercase tracking-[0.3em] font-bold text-[#E7CA83]">
          <span>IDENTITY</span>
    ...
    <!-- ==========================================
         SCENE 03 — MACRO PRODUCT REVEAL
         ========================================== -->
    <section id="scene-03" class="act-scene py-28 px-6 lg:px-16 max-w-7xl mx-auto border-b border-[#CCA147]/25">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
          <span class="text-xs font-serif uppercase tracking-[0.35em] text-[#CCA147] block mb-3">Scene 03 • Masterpiece Reveal</span>
          <h2 class="text-4xl sm:text-5xl font-serif font-bold text-[#FCFFFE] mb-6 uppercase">
            MADE TO BE RECOGNIZED.
          </h2>
          <p class="text-base text-[#FCFFFE]/90 leading-relaxed mb-6 font-sans">
            Handcrafted in solid 18k gold fill and natural royal blue sapphires. Created to act as a physical anchor of confidence, pride, and personal expression.
          </p>
          <div class="p-6 rounded-xl glass-liquid border-l-4 border-l-[#CCA147] mb-8">
            <span class="text-xs font-serif uppercase tracking-widest text-[#E7CA83] block mb-1">Featured Flagship Piece</span>
            <h3 class="font-serif font-bold text-xl text-[#FCFFFE]">Sigma Gamma Rho Centennial Sapphire Pendant</h3>
            <span class="text-lg font-serif font-bold text-[#CCA147] block mt-2">$285.00</span>
          </div>
          <button onclick="addToCart('Sigma Gamma Rho Centennial Sapphire Pendant', 285)" class="interactive-el btn-gold px-8 py-4 rounded text-xs uppercase tracking-widest">
            Acquire Flagship Masterpiece
          </button>
        </div>

        <div class="relative">
          <div class="w-full aspect-square rounded-2xl overflow-hidden border-2 border-[#CCA147] shadow-[0_0_50px_rgba(204,161,71,0.4)] glass-liquid p-4 flex items-center justify-center">
            <img id="flagship-master-img" class="max-h-full max-w-full object-contain rounded-xl">
          </div>
        </div>
      </div>
    </section>
    ...
    <!-- ==========================================
         SCENE 04 — DEDICATED REAL COLLECTION CAROUSELS
         ========================================== -->
    <section id="scene-04" class="act-scene py-28 px-6 lg:px-16 max-w-7xl mx-auto space-y-20">
      
      <div class="text-center mb-10">
        <span class="text-xs font-serif uppercase tracking-[0.35em] text-[#CCA147] block mb-3">Scene 04 • 120 Real Google Drive Jewelry Pieces</span>
        ...
        <p class="text-xs text-[#FCFFFE]/80 mt-2 font-mono">Use Left & Right Arrow controls to slide through all 120 embedded real jewelry items</p>
    ...
    <!-- ==========================================
         SCENE 05 — SISTERHOOD & HUMAN CONNECTION
         ========================================== -->
    <section id="scene-05" class="act-scene py-28 px-6 lg:px-16 max-w-7xl mx-auto border-t border-[#CCA147]/25 text-center">
      <span class="text-xs font-serif uppercase tracking-[0.35em] text-[#CCA147] block mb-3">Scene 05 • Sisterhood</span>
    ...
    <!-- ==========================================
         SCENE 06 — INTERACTIVE CUSTOMIZATION ENGINE
         ========================================== -->
    <section id="scene-06" class="act-scene py-28 px-6 lg:px-16 max-w-7xl mx-auto border-t border-[#CCA147]/25">
      <div class="text-center mb-12">
        <span class="text-xs font-serif uppercase tracking-[0.35em] text-[#CCA147] block mb-3">Scene 06 • Customization Studio</span>
        <h2 class="text-3xl sm:text-5xl font-serif font-bold text-[#FCFFFE] uppercase">
          CREATE SOMETHING UNFORGETTABLE
        </h2>
        <p class="text-xs text-[#FCFFFE]/80 mt-2 font-mono">Personalize metals, gemstones, monograms, and chapter engravings</p>
      </div>
    ...
    <!-- ==========================================
         SCENE 07 — ARCHIVAL LEGACY
         ========================================== -->
    <section id="scene-07" class="act-scene py-28 px-6 lg:px-16 max-w-7xl mx-auto border-t border-[#CCA147]/25 text-center">
      <span class="text-xs font-serif uppercase tracking-[0.35em] text-[#CCA147] block mb-3">Scene 07 • Archival Continuity</span>
      ...
      <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
        <a href="#scene-04" class="interactive-el btn-gold px-8 py-4 rounded-sm font-serif text-xs uppercase tracking-widest">
        ...
        <div class="lg:col-span-2 bg-[#001B55] border border-[#CCA147]/50 rounded-xl p-6 shadow-xl">
          ...
          <form onsubmit="handleAddProduct(event)" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div class="sm:col-span-2">
              ...
              <input type="text" id="prod-img" required placeholder="data:image/jpeg;base64,..." class="w-full bg-[#00123A] border border-[#CCA147]/40 p-2.5 rounded text-xs text-[#FCFFFE]">
            </div>
            <div class="sm:col-span-2">
        ...
        <div class="lg:col-span-5 bg-[#001B55] border border-[#CCA147]/40 rounded-xl p-6 shadow-xl">
          ...
          <div class="space-y-4">
            <div>
              ...
              <input type="text" id="studio-img-url" value="data:image/jpeg;base64,..." class="w-full bg-[#00123A] border border-[#CCA147]/30 p-2.5 rounded text-xs text-[#FCFFFE]">
            </div>
  ...
  <script>
    ...
    function renderUI() {
      ...
      collections.forEach(col => {
          ...
          <div class="glass-liquid rounded-2xl p-6 sm:p-8 border border-[#CCA147]/40 shadow-2xl relative">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 border-b border-[#CCA147]/25 pb-4">
              ...
              <div class="flex items-center gap-3">
                <button onclick="scrollCarousel('\${col.id}', 'left')" class="interactive-el w-10 h-10 rounded-full border border-[#CCA147]/60 bg-[#00123A] text-[#CCA147] hover:bg-[#003399] flex items-center justify-center transition shadow-md">
                  ←
                </button>
                <button onclick="scrollCarousel('\${col.id}', 'right')" class="interactive-el w-10 h-10 rounded-full border border-[#CCA147]/60 bg-[#00123A] text-[#CCA147] hover:bg-[#003399] flex items-center justify-center transition shadow-md">
                  →
                </button>
              </div>
            </div>
        ...
        col.images.forEach((b64Img, imgIdx) => {
          ...
          carouselsHtml += \`
            <div class="w-72 sm:w-80 flex-shrink-0 bg-[#00123A] border border-[#CCA147]/30 rounded-xl overflow-hidden group hover:border-[#CCA147] transition-all duration-300 flex flex-col justify-between">
              <div>
                <div class="relative h-64 bg-[#001B55] overflow-hidden flex items-center justify-center p-3">
                  <img src="\${b64Img}" alt="\${pieceTitle}" class="max-h-full max-w-full object-contain group-hover:scale-105 transition-transform duration-500">
                </div>
                <div class="p-4">
                  ...
                  <p class="text-[11px] text-[#FCFFFE]/75 leading-relaxed">Extracted fine jewelry design piece by Roslyn Kiser Miller.</p>
                </div>
              </div>
      ...
      if (flagshipImg && collections[3] && collections[3].images[0]) {
...
console.log('Masterpiece Spectacle-Driven Experience index.html built successfully!');
