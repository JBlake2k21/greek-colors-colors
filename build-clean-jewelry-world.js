...
// Read collections metadata and use assets paths for 100% browser rendering reliability
...
const cleanCollections = rawCollections.map(col => {
  return {
    ...
    images: col.images.map(imgObj => imgObj.url) // e.g. "assets/col-1-piece-1.jpg"
  };
});
...
<head>
  ...
  <title>Greek Colors Colors — Bespoke Sorority Fine Jewelry World</title>
  <meta name="description" content="Greek Colors Colors presents fine sorority jewelry handcrafted by Master Jeweler Roslyn Kiser Miller. Explore 120 authentic fine jewelry pieces celebrating identity, sisterhood, and legacy.">
...
<body class="min-h-screen flex flex-col selection:bg-[#CCA147] selection:text-[#001B55]">
  ...
  <!-- ANNOUNCEMENT BAR -->
  <div class="relative z-50 bg-[#001B55] border-b border-[#CCA147]/40 py-2 px-4 text-center text-xs font-serif tracking-[0.2em] text-[#E7CA83] flex items-center justify-between">
  ...
  <header id="main-header" class="sticky top-0 z-40 glass-nav px-6 lg:px-16 py-4 transition-opacity duration-1000">
    <div class="max-w-7xl mx-auto flex items-center justify-between">
      ...
      <nav class="hidden md:flex items-center space-x-8 text-xs font-serif uppercase tracking-[0.2em] text-[#FCFFFE]/90">
        <a href="#scene-01" onclick="switchTab('storefront')" class="interactive-el hover:text-[#CCA147] transition">Arrival</a>
        <a href="#scene-03" onclick="switchTab('storefront')" class="interactive-el hover:text-[#CCA147] transition">Flagship Vault</a>
        <a href="#scene-04" onclick="switchTab('storefront')" class="interactive-el hover:text-[#CCA147] transition">Fine Jewelry Collections</a>
        <a href="#scene-05" onclick="switchTab('storefront')" class="interactive-el hover:text-[#CCA147] transition">Sisterhood</a>
        <a href="#scene-06" onclick="switchTab('storefront')" class="interactive-el hover:text-[#CCA147] transition">Atelier Studio</a>
      </nav>
  ...
  <div id="view-storefront" class="tab-content relative z-10">
    ...
    <section id="scene-01" class="act-scene min-h-[85vh] flex items-center justify-center relative py-20 px-6 lg:px-16 overflow-hidden bg-gradient-to-b from-[#00123A]/80 via-[#001B55]/70 to-[#003399]/30">
      ...
      <div class="max-w-5xl mx-auto text-center relative z-10">
        ...
        <div class="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-[#001B55] border border-[#CCA147] text-[#E7CA83] text-xs font-serif uppercase tracking-[0.35em] mb-8 shadow-[0_0_35px_rgba(204,161,71,0.35)]">
          <span>✨</span> Welcome to Greek Colors Colors
        </div>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-5">
          <a href="#scene-04" class="interactive-el btn-gold px-10 py-5 rounded-sm font-serif text-xs uppercase tracking-[0.25em] w-full sm:w-auto">
            View All Fine Jewelry Collections →
          </a>
    ...
    <!-- ==========================================
         SCENE 03 — FLAGSHIP PRODUCT VAULT
         ========================================== -->
    <section id="scene-03" class="act-scene py-20 px-6 lg:px-16 max-w-7xl mx-auto border-t border-[#CCA147]/25">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
          <span class="text-xs font-serif uppercase tracking-[0.35em] text-[#CCA147] block mb-3">Featured Flagship Masterpiece</span>
          ...
          <p class="text-base text-[#FCFFFE]/90 leading-relaxed mb-6 font-sans">
            Handcrafted in solid 18k yellow gold fill and set with natural royal blue sapphires. Created to act as a physical anchor of confidence, pride, and personal expression.
          </p>
          <div class="p-6 rounded-xl glass-liquid border-l-4 border-l-[#CCA147] mb-8">
            <span class="text-xs font-serif uppercase tracking-widest text-[#E7CA83] block mb-1">Centennial Edition</span>
        ...
        <div class="relative">
          <div class="w-full aspect-square rounded-2xl overflow-hidden border-2 border-[#CCA147] shadow-[0_0_50px_rgba(204,161,71,0.4)] glass-liquid p-6 flex items-center justify-center">
            <img id="flagship-master-img" src="assets/col-4-piece-1.jpg" alt="Sigma Gamma Rho Centennial Sapphire Pendant" class="max-h-full max-w-full object-contain rounded-xl shadow-2xl">
          </div>
        </div>
      </div>
    </section>
    ...
    <!-- ==========================================
         ...
         ========================================== -->
    <section id="scene-04" class="act-scene py-20 px-6 lg:px-16 max-w-7xl mx-auto space-y-20">
...
console.log('Successfully generated clean, high-performance index.html with all 120 jewelry items linking to assets/ files!');
