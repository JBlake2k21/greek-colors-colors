...
<head>
  ...
  <title>Greek Colors Colors — Cosmic Mission Brief & Orbital 3D Showroom</title>
  <meta name="description" content="Greek Colors Colors Orbital Showroom Access. Mission Briefing and Systems Initialization sequence for bespoke sorority fine jewelry by Master Jeweler Roslyn Kiser Miller.">
  ...
  <div id="scene-zero-loader" class="fixed inset-0 z-50 flex flex-col justify-between p-8 md:p-14 overflow-hidden pointer-events-auto">
    ...
    <div class="flex items-center justify-between z-10 text-xs font-mono text-[#E7CA83]/80 tracking-widest uppercase border-b border-[#CCA147]/20 pb-4">
      <div class="flex items-center gap-3">
        ...
        <span>MISSION: GCC — ORBITAL COLLECTION 01</span>
      </div>
      <div class="hidden sm:flex items-center gap-6">
        <span>ENVIRONMENT: ROYAL SAPPHIRE / GOLD</span>
